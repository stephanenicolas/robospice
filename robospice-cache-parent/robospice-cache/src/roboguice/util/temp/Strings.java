...
public final class Strings {
         ...
         * sentences such as "Alice, Bob and Charlie" use ", " and " and " as
         * the delimiters.
         * @param delimiter
         *                usually ", "
         * @param lastDelimiter
        ...
        public static <T> String joinAnd(final String delimiter,
                ...
                while (iter.hasNext()) {
                        ...
                        if (notEmpty(obj)) {
                                buffer.append(++i == objs.size() ? lastDelimiter
                                                : delimiter).append(
        ...
        public static String md5(String s) {
                ...
                try {
                        ...
                        final byte[] hash = MessageDigest.getInstance("MD5")
                                        .digest(s.getBytes(CharEncoding.UTF_8));
                        ...
                        for (byte aHash : hash) {
                                ...
                                if (hex.length() == 1) {
                                        hashString.append('0');
                                        hashString.append(hex.charAt(hex
                                                        .length() - 1));
                                } else {
                                        hashString.append(hex.substring(hex
                                                        .length() - 2));
                                }
                        }
        ...
        public static String[] chunk(String str, int chunkSize) {
                ...
                for (int i = 0; i < arrayLen; ++i) {
                        array[i] = str.substring(i * chunkSize, i * chunkSize
