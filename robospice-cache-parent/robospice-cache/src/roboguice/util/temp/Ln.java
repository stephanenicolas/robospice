...
public final class Ln {
         ...
         * replaced by BaseConfig(ContextSingleton) during guice static
         * injection pass.
         */
         ...
         * static injection pass. This allows overriding where the log message
         * is delivered to.
         */
        ...
        public static int v(Object s1, Object... args) {
                ...
                final String message = args.length > 0 ? String.format(s, args)
                                : s;
        ...
        public static int v(Throwable throwable, Object s1, Object... args) {
                ...
                final String s = Strings.toString(s1);
                final String message = (args.length > 0 ? String
                                .format(s, args) : s)
                                + '\n'
        ...
        public static int d(Throwable t) {
                return config.minimumLogLevel <= Log.DEBUG ? print.println(
                                Log.DEBUG, Log.getStackTraceString(t)) : 0;
        }
        ...
        public static int i(Throwable t) {
                return config.minimumLogLevel <= Log.INFO ? print.println(
                                Log.INFO, Log.getStackTraceString(t)) : 0;
        }
        ...
        public static int w(Throwable t) {
                return config.minimumLogLevel <= Log.WARN ? print.println(
                                Log.WARN, Log.getStackTraceString(t)) : 0;
        }
        ...
        public static int e(Throwable t) {
                return config.minimumLogLevel <= Log.ERROR ? print.println(
                                Log.ERROR, Log.getStackTraceString(t)) : 0;
        }
        ...
        public static class BaseConfig implements Config {
                ...
                public BaseConfig(Application context) {
                        try {
                                ...
                                Log.e(packageName, "Error configuring logger",
                                                e);
                        }
                }
        ...
        public static class Print {
                ...
                public int println(int priority, String msg) {
                        return Log.println(priority, getScope(),
                                        processMessage(msg));
                }
                ...
                protected static String getScope() {
                        if (config.minimumLogLevel <= Log.DEBUG) {
                                final StackTraceElement trace = Thread
                                                .currentThread()
