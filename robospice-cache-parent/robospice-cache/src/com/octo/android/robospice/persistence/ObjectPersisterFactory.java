...
public abstract class ObjectPersisterFactory implements Persister {
        ...
        /**
         * Creates an {@link ObjectPersisterFactory} given an Android
         * application. As no list of handled classes is specified, it will act
         * has if it can handle all classes.
         * @param application
         *                the android context needed to access android file
         *                system or databases to store.
         */
        ...
        /**
         * Creates an {@link ObjectPersisterFactory} given an Android
         * application and a list of handled classes.
         * @param application
         *                the android context needed to access android file
         *                system or databases to store.
         * @param listHandledClasses
         *                the list of classes that is handled by the factory.
         *                The factory will try to produce an
        ...
        /**
         * Wether or not this bus element can persist/unpersist objects of the
         * given class clazz.
         * @param clazz
         ...
         * @param clazz
         *                the class of the items that need to be saved/loaded
         *                from cache.
         * @return a {@link ObjectPersister} able to load/save instances of
         *         class clazz.
         */
         ...
         * {@link ObjectPersister} instances it produces to save data
         * asynchronously or not.
         * @param isAsyncSaveEnabled
         *                whether or not data will be saved asynchronously by
         *                {@link ObjectPersister} instances produced by this
         *                factory.
         */
         ...
         * {@link ObjectPersister} instances it produces to save data
         * asynchronously or not.
         * @return true if the {@link ObjectPersister} instances it produces to
         *         save data asynchronously. False otherwise.
         */
