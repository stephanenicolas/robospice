...
public interface ICacheManager {
        ...
        /**
         * Loads an instance of a class clazz, that is stored in cache under the
         * key cacheKey.
         * @param clazz
         *                the class of the object that is supposed to be stored
         *                in cache.
         * @param cacheKey
         *                the key used to identify this item in cache.
         * @param maxTimeInCacheBeforeExpiry
         *                the maximum time (in ms) an item can be stored in
         *                cache before being considered expired.
         * @return an instance of a class clazz, that is stored in cache under
         *         the key cacheKey. If the item is not found in cache or is
         *         older than maxTimeInCacheBeforeExpiry, then this method will
         *         return null.
        ...
        /**
         * Save an instance of a given class, into the cache identified by
         * cacheKey. Some {@link ObjectPersister} can modify the data they
         * receive before saving it. Most {@link ObjectPersister} instances will
         * just save the data as-is, in this case, they can even return it and
         * save it asynchronously in a background thread for a better
         * efficiency.
         * @param data
         ...
         * @return a boolean indicating whether or not this data could be
         *         removed.
         */
