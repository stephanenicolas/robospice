...
import com.octo.android.asynctest.R;
import com.octo.android.asynctest.common.BaseActivity;
import com.octo.android.asynctest.model.tweeter.ListTweets;
import com.octo.android.asynctest.model.tweeter.Tweet;
...
public class TweeterSpiceActivity extends BaseActivity {
    ...
    private SpiceManager spiceManager = new SpiceManager( TweeterSpiceService.class );
    ...
    public void startDemo() {
        ...
        tweetRequest = new TweetRequest( delay );
        spiceManager.execute( tweetRequest, "tweets", DurationInMillis.NEVER, new TweetRequestListener() );
    }
    ...
    private class TweetRequestListener implements RequestListener< ListTweets >, RequestProgressListener {
        ...
        public void onRequestFailure( SpiceException arg0 ) {
            if ( !( arg0 instanceof RequestCancelledException ) ) {
                Toast.makeText( TweeterSpiceActivity.this, "Failed to load Twitter data.", Toast.LENGTH_SHORT ).show();
            }
        }
