...
public interface ICacheManager {
    ...
    public abstract void addPersister( Persister persister );

    public abstract void removePersister( Persister persister );
     ...
     */
    public abstract < T > List< Object > getAllCacheKeys( Class< T > clazz );
     ...
     */
    public abstract < T > List< T > loadAllDataFromCache( Class< T > clazz ) throws CacheLoadingException;
