...
public class JsonObjectPersisterFactory extends InFileObjectPersisterFactory {
    ...
    public JsonObjectPersisterFactory( Application application, JsonFactory jsonFactory, List< Class< ? >> listHandledClasses ) {
    ...
    public < DATA > InFileObjectPersister< DATA > createObjectPersister( Class< DATA > clazz ) {
        InFileObjectPersister< DATA > inFileObjectPersister = new JsonObjectPersister< DATA >( getApplication(), clazz, getCachePrefix(), jsonFactory );
