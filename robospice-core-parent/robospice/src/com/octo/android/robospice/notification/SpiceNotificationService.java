...
public abstract class SpiceNotificationService extends Service {
        ...
        private class NotificationRequestListener<T> implements
                        RequestListener<T>, RequestProgressListener {
