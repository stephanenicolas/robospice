...
public class TweeterJsonSpringAndroidSpiceActivity extends BaseActivity {
    ...
    private TweetJsonSpringAndroidRequest tweetJsonSpringAndroidRequest;
    ...
    public void startDemo() {
        ...
        tweetJsonSpringAndroidRequest = new TweetJsonSpringAndroidRequest( delay );
        spiceManager.execute( tweetJsonSpringAndroidRequest, JSON_CACHE_KEY, DurationInMillis.NEVER, new TweetRequestListener() );
    }

    @Override
    public void stopDemo() {
        if ( tweetJsonSpringAndroidRequest != null ) {
            tweetJsonSpringAndroidRequest.cancel();
        }
    }
    ...
    private class TweetRequestListener implements RequestListener< ListTweets >, RequestProgressListener {
        ...
        public void onRequestFailure( SpiceException arg0 ) {
            if ( !( arg0 instanceof RequestCancelledException ) ) {
                Toast.makeText( TweeterJsonSpringAndroidSpiceActivity.this, "Failed to load Twitter data.", Toast.LENGTH_SHORT ).show();
            }
        }
