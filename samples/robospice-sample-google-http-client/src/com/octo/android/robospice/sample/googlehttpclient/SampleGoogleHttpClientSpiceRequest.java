...
public class SampleGoogleHttpClientSpiceRequest extends GoogleHttpClientSpiceRequest< WeatherResult > {

    private String baseUrl;

    public SampleGoogleHttpClientSpiceRequest( String zipCode ) {
