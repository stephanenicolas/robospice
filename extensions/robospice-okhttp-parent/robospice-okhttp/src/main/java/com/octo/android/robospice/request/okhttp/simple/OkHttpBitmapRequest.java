...
public class OkHttpBitmapRequest extends OkHttpSpiceRequest<Bitmap> implements IBitmapRequest {
     ...
     */
    public OkHttpBitmapRequest(String url, File cacheFile) {
     ...
     *            a file used to store data during download.
     */
    public OkHttpBitmapRequest(String url, BitmapFactory.Options options, File cacheFile) {
        super(Bitmap.class);
        this.url = url;
     ...
     *            a file used to store data during download.
     */
    public OkHttpBitmapRequest(String url, int width, int height, File cacheFile) {
        super(Bitmap.class);
        this.url = url;
        this.width = width;
        this.height = height;
