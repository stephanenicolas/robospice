...
/**
 * This {@link ListView} is optimized to display some content that contains image loaded from the network via RoboSpice.
 * It uses a {@link SpiceArrayAdapter} to hold data and create/update views. It can be instanciated programmatically or
 * via XML.
 * 
 * Basically, it will load images only when scrolling is stopped.
 * 
 * @author sni
 * 
 */
