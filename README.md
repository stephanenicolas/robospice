...
* Build Status on CloudBees:[![Build Status on CloudBees:](https://robospice.ci.cloudbees.com/job/Build%20RoboSpice/badge/icon)](https://robospice.ci.cloudbees.com/job/)
